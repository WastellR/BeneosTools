...
#include "C0TTRPGCineCam.generated.h"

class AC0Grid;

UCLASS(config = BeneosTools, meta = (DisplayName = "Beneos Cine Cam"))
class BENEOSTOOLS_API AC0TTRPGCineCam : public ACineCameraActor
{
    GENERATED_BODY()

public:

    AC0TTRPGCineCam(const FObjectInitializer& ObjectInitializer);
